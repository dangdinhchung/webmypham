        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="box">
                    ...
                    <p>Tổng tiền cần thanh toán: <b>{{ number_format($transaction->tst_total_money,0,',','.') }} đ</b></p> (Đã bao gồm phí vận chuyển: <b>{{ number_format(App\Models\Product::SHIPPING_COST,0,',','.') }} đ</b>)
                    @if ($couponDetail)
