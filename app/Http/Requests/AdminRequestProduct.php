...
class AdminRequestProduct extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'pro_number_import' => 'required|integer|min:1',
    ...
    public function messages()
    {
        return [
            ...
            'pro_number_import.required' => 'Số lượng không được bỏ trống',
            'pro_number_import.integer'  => 'Số lượng sai định dạng',
            'pro_number_import.min'      => 'Số lượng phải lớn hơn 0',
