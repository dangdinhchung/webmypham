...
/***/ "./resources/js/components/upload_image.js":
/*!*************************************************!*\
  !*** ./resources/js/components/upload_image.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {var UploadImage = {
  init: function init() {
  ...
  processUploads: function processUploads() {
    ...
    $("body").on("change", ".js-input-image", function (event) {
      event.preventDefault();
      var $this = $(this);
      var $gallery = $this.parents('form').find('div.gallery');
      imagesPreview(this, $gallery); // imagesPreview(this, 'div.gallery');
    });
  }
};
...
/* harmony import */ var _components_upload_image__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/upload_image */ "./resources/js/components/upload_image.js");
/* harmony import */ var _common_lazyload_file__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/lazyload_file */ "./resources/js/common/lazyload_file.js");
...
/* harmony import */ var jquery_modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! jquery-modal */ "./node_modules/jquery-modal/jquery.modal.js");
...
var ProductDetail = {
  ...
  showFormReview: function showFormReview() {
    ...
    $(".js-review").click(function (event) {
      ...
      if ($this.hasClass('js-check-login')) {
        toastr__WEBPACK_IMPORTED_MODULE_6___default.a.warning("Đăng nhập để thực hiện chức năng này");
        return false;
      }
  ...
  processReview: function processReview() {
    ...
    $(".js-process-review").click(function (event) {
      ...
      $.ajax({
        ...
        toastr__WEBPACK_IMPORTED_MODULE_6___default.a.success(results.messages);
      });
    });
  },
  ...
  submitCaptcha: function submitCaptcha() {
    $('.js-submit-captcha').on('click', function (e) {
      ...
      if (!recaptcha) {
        toastr__WEBPACK_IMPORTED_MODULE_6___default.a.warning('Bạn chưa xác nhận "Tôi không phải người máy" kìa!');
        return false;
      }
      ...
      $.ajax({
        ...
        toastr__WEBPACK_IMPORTED_MODULE_6___default.a.success(results.message);
        setTimeout(function () {
          window.location.reload();
        }, 2000);
      });
  ...
  loadCssLazy: function loadCssLazy() {
    if (typeof CSS != 'undefined') {
      Object(_common_lazyload_file__WEBPACK_IMPORTED_MODULE_5__["loadCss"])(CSS);
    }
  },
    ...
    $(".js-add-favourite").click(function (event) {
      ...
      if (URL) {
        $.ajax({
          ...
          toastr__WEBPACK_IMPORTED_MODULE_6___default.a.warning(results.messages);
        });
      }
    });
  },
...
$(function () {
  ...
  _components_upload_image__WEBPACK_IMPORTED_MODULE_4__["default"].init();
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
...
module.exports = __webpack_require__(/*! D:\xampp\htdocs\webmypham\resources\js\pages\product_detail.js */"./resources/js/pages/product_detail.js");
