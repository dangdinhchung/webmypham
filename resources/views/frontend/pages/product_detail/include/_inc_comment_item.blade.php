<div class="item">
    ...
    @endif
    <p class="item-footer">
        {{--<a href="" class="js-show-form-reply" data-name="{{ $comment->user->name ?? "[N\A]" }}" data-id="{{ $comment->cmt_parent_id ? $comment->cmt_parent_id : $comment->id }}" data-product="{{ $comment->cmt_product_id }}">Trả lời</a>--}}
        <span>-</span>
