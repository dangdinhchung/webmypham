...
class AdminProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.product.create',
            compact('categories', 'attributeOld', 'attributes', 'keywords', 'keywordOld'));
    }

    /**
     * @param AdminRequestProduct $request
...
//	}
    ...
    {
        $products = Product::where('pro_category_id', $request->category_id)->select('id', 'pro_name',
            'pro_category_id')->get();
        return $products;
    }
